...

{
    ...
    constructor(){
      ...
      this._player=new Array(3);
       for(let i=0;i<this._player.length;i++){
          ...
          this._player[i].src="images/"+JANKEN_TYPE[i]+".png";
  ...
  class Opponent{ //相手のクラス
    constructor(){
      ...
      this._img.src="images/"+JANKEN_TYPE[this._rdNum]+".png";
  ...
  const JANKEN_TYPE=["gu-","tyoki","pa-"]; //じゃんけんタイプの配列
